...
hg import --no-commit ../authorities.patch ../icons.patch ../target_package_change.patch ../removed-send-batching.patch ../enable_autocomplete.patch ../fix_backspace_bug_in_autocomplete.patch ../warning_message_toast_for_autocomplete.patch ../download_external_dataset.patch
